...
STAMPED_BIN_PATH = f"{os.path.abspath(os.path.dirname(__file__))}\\stamped_raw\\"
STAMPED_FRAME_PATH = f"{get_root_path()}\\stamped_frames\\"
...
def main():
    ...
    radar = Radar(args.cfg, stamped_data_path=STAMPED_BIN_PATH, host_ip="192.168.33.30")
    print("inited radar")
    print("this is root path", STAMPED_BIN_PATH)
