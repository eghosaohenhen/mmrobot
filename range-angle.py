...
def main():
    ...
    heatmap = RangeAngleHeatmap(range_res=params["range_res"], angle_bins=32)
    ...
    def update_frame(msg):
        ...
        data = np.fft.fft2(frame, s=[padding_size[0], padding_size[1]], axes=[0, 1])
